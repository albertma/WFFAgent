...
import datetime
import logging
from . import file_lru_cache as filecache
...
if __name__ == "__main__":
    ...
    #reports = get_stock_financial_report_cn("000333")
    
    #print(reports["balancesheet"].head(2).to_json(force_ascii=False ,orient="records"))
    #print(reports["incomestatement"].head(20).to_json(force_ascii=False ,orient="records"))

        ...
        try:
            async with stdio_client(server_params) as (read, write):
                async with ClientSession(read, write) as session:
                    ...
                    log.info("Creating agent executor...")
                    agent_executor = self.create_agent_executor(toolkit=toolkit, system_prompt=system_prompt, user_message_prompt=user_message_prompt)
                    log.info("Created agent Executor, invoke executor with input: {input}")
